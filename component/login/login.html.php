...
class loginHTML {
	...
	function loginpage ( &$params, $image ) {
		...
		?>
		<form action="<?php echo sefRelToAbs( 'index.php?c=in' ); ?>" method="post" name="login" id="login">
		...
		<tr>
			<td align="center" width="50%">
				...
				<tr>
					...
					<br/>
					<a href="<?php echo sefRelToAbs( 'reg/lostPassword' ); ?>">
					<?php echo _LOST_PASSWORD; ?>
					</a>
						<br/>Новый пользователь - 
						<a href="<?php echo sefRelToAbs( 'reg/register' ); ?>">регистрация</a>
					<br/><br/><br/>
					</td>
				</tr>
				</table>
