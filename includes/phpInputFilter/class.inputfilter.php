...
class InputFilter
{
	...
	function filterTags($source)
	{
		...
		while ($tagOpen_start !== false)
		{
			 ...
			 */
			if ((!preg_match("/^[a-z][a-z0-9]*$/i", $tagName)) || (!$tagName) || ((in_array(mb_strtolower($tagName,"UTF-8"), $this->tagBlacklist)) && ($this->xssAuto)))
			{
	...
	{
		$attrSubSet[0] = mb_strtolower($attrSubSet[0],"UTF-8");
		$attrSubSet[1] = mb_strtolower($attrSubSet[1],"UTF-8");
