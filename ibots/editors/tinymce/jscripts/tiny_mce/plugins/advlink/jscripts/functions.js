...
function setPopupControlsDisabled(state) {
	if (!state){
		if (  document.forms[0].href.value!=''  )
			document.forms[0].popupurl.value = document.forms[0].href.value;
	}
	var formObj = document.forms[0];
...
function buildOnClick() {
	var e24srcurl = document.forms[0].popupurl.value;
	if (e24srcurl.length>3)
		if (  (e24srcurl.substring ( (e24srcurl.length-3) , (e24srcurl.length) )=='jpg')  ||  (e24srcurl.substring ( (e24srcurl.length-3) , (e24srcurl.length) )=='png')  ||  (e24srcurl.substring ( (e24srcurl.length-3) , (e24srcurl.length) )=='gif')  ){
			hiddenImg= new Image();
			hiddenImg.src= document.forms[0].popupurl.value;
		}
	...
	if (url.length>3)
		if (  (url.substring ( (url.length-3) , (url.length) )=='jpg')  ||  (url.substring ( (url.length-3) , (url.length) )=='png')  ||  (url.substring ( (url.length-3) , (url.length) )=='gif')  ){
			if (hiddenImg.width!="")
				formObj.popupwidth.value = hiddenImg.width+20;
			if (hiddenImg.height!="")
				formObj.popupheight.value = hiddenImg.height+25;
