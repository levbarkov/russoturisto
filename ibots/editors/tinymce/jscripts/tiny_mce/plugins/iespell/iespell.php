...
function insertAction_FullImg() {
	...
	var html = "<img src='" + document.forms[0].e24fimg.value + "' width='" +hiddenImg.width + "' height='" +hiddenImg.height + "'>";
	tinyMCE.execCommand('mceInsertContent', false, html);			
	tinyMCEPopup.close();
}
...
function insertAction_FullImgLink() {
	...
	var html = "<a href='" + document.forms[0].txtUrl.value + "'><img src='" + document.forms[0].e24fimg.value + "' border='0' width='" + hiddenImg.width + "' height='" + hiddenImg.height + "'></a>";
	tinyMCE.execCommand('mceInsertContent', false, html);			
	tinyMCEPopup.close();
}
				...
				<tr height="100%" >
					<td align="justify">
						...
						<tr>
							...
							<td align="left"><input type="button" id="ggprvfimg" name="ggprvfimg" value="Загрузить п. фото" onClick='window.open(document.getElementById("e24fimg").value,"subWind","status,menubar, scrollbars,resizable,height=600,width=600")' /></td>
