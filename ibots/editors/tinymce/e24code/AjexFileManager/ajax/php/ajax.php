...
// именно этот массив используется - в него прописывать разрешения
$cfg_mail_allor_files = array('jpg', 'jpeg', 'gif', 'png', 'bmp', 'tif', 'tiff', 'psd', 
					'7z', 'gz', 'gzip', 'rar', 'zip', 'tar', 'tgz', 
					'aiff', 'asf', 'avi', 'csv', 'fla', 'flv', 'mid', 'mov', 'mp3', 'mp4', 'mpc', 'mpeg', 'mpg', 
					'ods', 'odt', 'pdf', 'ppt', 'pxd', 'qt', 'xls', 'xml', 'doc', 'txt', 'vsd', 
					'ram', 'rm', 'rmi', 'rmvb', 'rtf', 'sdc', 'sitd', 'swf', 'sxc', 'sxw', 'wav', 'wma', 'wmv');

$cfg['allow'] = array(
	'file'	=> $cfg_mail_allor_files,
	'flash'	=> $cfg_mail_allor_files,//array('swf', 'flv'),
	'image'	=> $cfg_mail_allor_files,
	'media'	=> $cfg_mail_allor_files //array('aiff', 'asf', 'avi', 'bmp', 'fla', 'flv', 'gif', 'jpeg', 'jpg', 'mid', 'mov', 'mp3', 'mp4', 'mpc', 'mpeg', 'mpg', 'png', 'qt', 'ram', 'rm', 'rmi', 'rmvb', 'swf', 'tif', 'tiff', 'wav', 'wma', 'wmv')
);
