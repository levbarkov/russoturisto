...
function appendFiles(reply)
{
	...
	for (var i in files) {
		...
		thumb += '</div><div class="check"><a class="highslide" onclick="return hs.htmlExpand(this, {outlineType: \'rounded-white\', wrapperClassName: \'draggable-header\', objectType: \'ajax\', width: \'650\', height: \'650\', align : \'center\'} )" href="/ibots/editors/tinymce/e24code/phpimageeditor/index.php?imagesrc=../../../../..'+$cfg.url+$cfg.dir+'/'+files[i].name+'"><img src="/ibots/editors/tinymce/e24code/img/edit.png" style="border:0; width:16px; height:16px;" height="16" width="16" alt="" /></a><br /><input type="checkbox" name="file[]" value="' + files[i].name + '" /></div>';
