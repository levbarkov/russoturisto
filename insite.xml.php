        ...
        function render( $name='params' ) {
                ...
                if ($this->_path) {
                        if (!is_object( $this->_xmlElem )) {
                                require_once( site_path . '/includes/domit/xml_domit_lite_include.php' );
				...
				$html[] = '<tr><td colspan="2">' . $description . '</td></tr>';
                        ...
                        //$params = iParseParams( $row->params );
...
*/
        function renderParam( &$param, $control_name='params' ) {
			...
			$result[0] = iToolTip( addslashes( $description ), addslashes( $result[0] ), '', '', $result[0], '#', 0 );
                }
                ...
                if ( $description ) {
                        $result[2] = iToolTip( $description, $result[0] );
                        $result[2] = '';
                } else {
                        $result[2] = '';
                }
        ...
        */
        function _form_filelist( $name, $value, &$node, $control_name ) {
                ...
                $path         = site_path . $node->getAttribute( 'directory' );
